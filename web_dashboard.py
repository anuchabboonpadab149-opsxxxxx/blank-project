...
def fortune_post():
    ...
    fortunes = {
        ...
        "การเดินทาง": [
            "เหมาะกับการวางแผนทริปสั้น ๆ ใกล้บ้าน",
            "ระวังการล่าช้าของเวลา เดินทางเผื่อเวลาไว้",
            "มีเกณฑ์พบเรื่องราวดี ๆ ระหว่างทาง",
            "สถานที่ใกล้น้ำหรือภูเขาจะเสริมพลังงานบวก",
            "เลือกเส้นทางใหม่ ๆ จะพบแรงบันดาลใจ",
        ],
        "การศึกษา": [
            "สมาธิดี เหมาะกับการอ่าน/ทบทวนเนื้อหา",
            "ตั้งเป้าหมายเล็ก ๆ แล้วค่อย ๆ ทำให้สำเร็จ",
            "ระวังความเครียดจากการกดดันตัวเองมากไป",
